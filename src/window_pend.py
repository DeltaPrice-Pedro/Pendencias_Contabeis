...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_companies.sizePolicy().hasHeightForWidth())
        self.pushButton_companies.setSizePolicy(sizePolicy1)
        font = QFont()
        ...
        sizePolicy3.setHeightForWidth(self.listWidget_companie.sizePolicy().hasHeightForWidth())
        self.listWidget_companie.setSizePolicy(sizePolicy3)
        font3 = QFont()
        font3.setFamilies([u"Century"])
        ...
        sizePolicy4.setHeightForWidth(self.label_title_taxes.sizePolicy().hasHeightForWidth())
        self.label_title_taxes.setSizePolicy(sizePolicy4)
        self.label_title_taxes.setFont(font1)
        ...
        sizePolicy6.setHeightForWidth(self.stackedWidget_email.sizePolicy().hasHeightForWidth())
        self.stackedWidget_email.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.lineEdit_name_func.sizePolicy().hasHeightForWidth())
        self.lineEdit_name_func.setSizePolicy(sizePolicy7)
        font8 = QFont()
        ...
        font9.setBold(False)
        self.pushButton_cancel_email.setFont(font9)
...
"border-radius: 8px;")
        ...
        self.pushButton_cancel_email.setIcon(icon4)
        ...
        self.pushButton_send_email.setFont(font9)
...
"border-radius: 8px;")
        ...
        self.pushButton_send_email.setIcon(icon5)
        ...
        self.groupBox_sheet.setFont(font5)
        ...
        self.label_util_sheet.setFont(font10)
        ...
        self.label_from_sheet.setFont(font10)
        ...
        self.pushButton_sheet_func.setFont(font9)
...
"border-radius: 8px;")
        ...
        self.pushButton_sheet_func.setIcon(icon6)
        ...
        self.groupBox_func.setFont(font5)
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_add_func.sizePolicy().hasHeightForWidth())
        self.pushButton_add_func.setSizePolicy(sizePolicy1)
        self.pushButton_add_func.setFont(font9)
...
"border-radius: 8px;")
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_remove_func.sizePolicy().hasHeightForWidth())
        self.pushButton_remove_func.setSizePolicy(sizePolicy1)
        self.pushButton_remove_func.setFont(font9)
...
"border-radius: 8px;")
        icon8 = QIcon()
        icon8.addFile(u"../../../../../Downloads/remove_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_remove_func.setIcon(icon8)
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_edit_func.sizePolicy().hasHeightForWidth())
        self.pushButton_edit_func.setSizePolicy(sizePolicy1)
        self.pushButton_edit_func.setFont(font9)
...
"padding: 5px;\n"
"border-radius: 8px;")
        icon9 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.MailMessageNew))
        self.pushButton_edit_func.setIcon(icon9)
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_save_func.sizePolicy().hasHeightForWidth())
        self.pushButton_save_func.setSizePolicy(sizePolicy1)
        self.pushButton_save_func.setFont(font9)
...
"border-radius: 8px;")
        ...
        font11 = QFont()
        font11.setFamilies([u"Tw Cen MT"])
