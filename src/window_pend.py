...
"")
        ...
        sizePolicy6.setHeightForWidth(self.lineEdit_name_func.sizePolicy().hasHeightForWidth())
        self.lineEdit_name_func.setSizePolicy(sizePolicy6)
        font6 = QFont()
        ...
        sizePolicy5.setHeightForWidth(self.pushButton_reload_companie.sizePolicy().hasHeightForWidth())
        self.pushButton_reload_companie.setSizePolicy(sizePolicy5)
        icon7 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.SyncSynchronizing))
        self.pushButton_reload_companie.setIcon(icon7)
