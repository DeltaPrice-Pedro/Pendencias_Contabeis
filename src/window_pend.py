...
"")
        ...
        self.pushButton_add_func.setIcon(icon1)
        ...
        self.pushButton_remove_func.setIcon(icon2)
        ...
        self.pushButton_edit_func.setIcon(icon3)
        ...
        self.pushButton_save_func.setIcon(icon4)
