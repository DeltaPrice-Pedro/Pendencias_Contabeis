...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listWidget_companie.setFont(font1)
        ...
        font2.setBold(True)
        self.label_companie_intro.setFont(font2)
        ...
        font3.setBold(False)
        self.label_companie_subintro.setFont(font3)
        ...
        sizePolicy3.setHeightForWidth(self.pushButton_reload_companie.sizePolicy().hasHeightForWidth())
        self.pushButton_reload_companie.setSizePolicy(sizePolicy3)
        ...
        self.label_current_companie.setFont(font2)
